...
@section('content')
	...
	<div class="mws-panel grid_8">
        ...
        <div class="mws-panel-body no-padding">
        	<form class="mws-form" action="/admin/friends" method="post" enctype="multipart/form-data" onsubmit="return checkForm()">
        		{{ csrf_field() }}
        		<div class="mws-form-inline">
        			<div class="mws-form-row">
        				<label class="mws-form-label">友情链接名称 <span class="required">*</span></label>
        				<div class="mws-form-item">
        					<input type="text" name="friend_name" class="small" id="friend_name" value="{{ old('friend_name') }}" placeholder="友情链接名称" onblur="checkfriend_name()">
        				</div>
					...
					<div class="mws-form-row">
                        ...
                        <div class="mws-form-item">
                            <input type="text" name="url" class="small"  id="url" value="{{ old('url') }}" placeholder="友情链接地址" onblur="checkUrl()">
                        </div>
                        <span id="urlErr"></span>
                    </div>
        		</div>
