...
@section('content')
	...
	<div class="mws-panel grid_8">
        ...
        <div class="mws-panel-body no-padding">
        	<form class="mws-form" action="/admin/webconfigs" method="post" enctype="multipart/form-data" onsubmit="return checkForm()">
        		{{ csrf_field() }}
        		<div class="mws-form-inline">
        			<div class="mws-form-row">
        				<label class="mws-form-label">网站名称 <span class="required">*</span></label>
        				<div class="mws-form-item">
        					<input type="text" name="name" class="small" id="name" value="{{ old('name') }}" placeholder="网站名称" onblur="checkName()">
        				</div>
					...
					<div class="mws-form-row">
                        ...
                        <div class="mws-form-item">
                            <input type="text" name="describe" class="small" name="describe" id="describe" value="{{ old('describe') }}" onblur="checkDescribe()">
                        </div>
        			...
        			<div class="mws-form-row">
                        ...
                        <div class="mws-form-item">
                           <input type="text" name="filing" class="small" name="filing" id="filing" value="{{ old('filing') }}" onblur="checkFiling()">
                        </div>
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item">
                           <input type="text" name="telephone" class="small" name="telephone" id="telephone" value="{{ old('telephone') }}" onblur="checkPhone()">
                        </div>
